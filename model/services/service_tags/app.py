...
# service_tags_model = keras.models.load_model(r"D:\Coding\karira2\service_tags_model\my_model")
service_tags_model = keras.models.load_model("/app/service_tags_model/my_model")
...
def predict():
    ...
    predicted_probabilities = service_tags_model.predict(user_input)
