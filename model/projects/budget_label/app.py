...
# budget_label_model = keras.models.load_model(r"D:\Coding\karira2\budget_label_model\my_model")
budget_label_model = keras.models.load_model("/app/budget_label_model/my_model")
...
def predict():
    ...
    predicted_probabilities = budget_label_model.predict(user_input)
